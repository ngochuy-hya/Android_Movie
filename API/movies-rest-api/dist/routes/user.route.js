...
router.post("/verify-otp", [], controllers_1.UserController.verifyOtp);
router.post("/change-password", middleware_1.authenticateToken, controllers_1.UserController.changePassword);
